...
// METHOD POST
router.post("/", validators_1.purchaseValidators.validateCreateFields, validators_1.purchaseValidators.validateProviderIdExists, validators_1.purchaseValidators.validateUserCIExists, validators_1.purchaseValidators.validateTypePaymentIdExists, middlewares_1.validateFields, purchaseController.create); // http://localhost:3000/api/purchase
//METHOD PATCH
router.patch("/:id", validators_1.purchaseValidators.validateUpdateFields, validators_1.purchaseValidators.validateProviderIdExists, validators_1.purchaseValidators.validateUserCIExists, validators_1.purchaseValidators.validateTypePaymentIdExists, middlewares_1.validateFields, purchaseController.update); // http://localhost:3000/api/purchase/:id
//METHOD DELETE
