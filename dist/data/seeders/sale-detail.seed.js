...
exports.saleDetailSeed = void 0;
const config_1 = require("src/config");
const saleDetailSeed = async () => {
    try {
        ...
        const createdDetails = await config_1.SaleDetailDB.bulkCreate(finalDetails);
...
exports.saleDetailSeed = saleDetailSeed;
